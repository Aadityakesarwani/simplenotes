...
public abstract class Hilt_NotesListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NotesListFragment() {
    super();
  }

  Hilt_NotesListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotesListFragment_GeneratedInjector) this.generatedComponent()).injectNotesListFragment(UnsafeCasts.<NotesListFragment>unsafeCast(this));
    }
  }
